...
2. analysis (학업 성취 및 교과/비교과 분석)
  - grade_trend: 학년별 성적을 분리 분석.
    * semester_grades: "1학년: O등급(원점수) / 2학년: O등급 / 3학년: O등급" 등 생기부에 흩어진 주요 과목 성적을 학년별로 보기 좋게 요약 문장으로 정리 (없다면 '학기별 성적 데이터 부족' 표기)
    * storytelling: 전체 학기 성적 추이(상승/하락/유지)를 분석하고, 이 학업 곡선을 향후 자소서/면접에서 어떤 강점 스토리텔링으로 풀어낼지 제안 (2~3문장).
